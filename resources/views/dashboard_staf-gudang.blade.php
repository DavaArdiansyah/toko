...
@section('content')
    <h1>Dashboard STAF GUDANG</h1>
    <div class="dashboard">
        <div class="stat-box">
            <a href="{{route('kategori.index')}}" class="box">
                <p>Kategori</p>
            </a>
        </div>
        <div class="stat-box">
            <a href="{{route('jenis.index')}}" class="box">
                <p>Jenis</p>
            </a>
        </div>
        <div class="stat-box">
            <a href="{{route('barang.index')}}" class="box">
                <p>Barang</p>
            </a>
        </div>
        <div class="stat-box">
            <a href="{{route('barang_masuk.index')}}" class="box">
                <p>Barang Masuk</p>
            </a>
        </div>
        <div class="stat-box">
            <a href="{{route('retur_barang.index')}}" class="box">
                <p>Retur Barang</p>
            </a>
        </div>
    </div>
